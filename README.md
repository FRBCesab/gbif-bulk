...
-   [`DESCRIPTION`](https://github.com/frbcesab/gbif-bulk/tree/main/DESCRIPTION):
    contains project metadata (authors, date, dependencies, etc.)

-   [`make.R`](https://github.com/frbcesab/gbif-bulk/tree/main/make.R):
    main R script to run the entire project

-   [`R/`](https://github.com/frbcesab/gbif-bulk/tree/main/R): contains
...
Launch the
[`make.R`](https://github.com/frbcesab/gbif-bulk/tree/main/make.R) file
with:
